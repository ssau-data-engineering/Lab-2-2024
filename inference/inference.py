...
wait_for_new_file = FileSensor(
    ...
    filepath=os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', 'data'),  # Target folder to monitor
...
extract_audio = DockerOperator(
    ...
    image='yanashurinova/ffmeg_image',
...
transform_audio_to_text = DockerOperator(
    ...
    image='yanashurinova/ml_model_image',
