...
wait_get_new_videofile = FileSensor(
    task_id='wait_get_new_videofile',
    poke_interval=15, 
...
extract_audiotrack_from_video = DockerOperator(
    ...
    command='-i /opt/airflow/data/input_video.mp4 -vn -acodec copy /opt/airflow/data/audio.aac',
    mounts=[Mount(source='/opt/airflow/data', target='/opt/airflow/data', type='bind')],
